...
export default async function axiosFetch({
  ...
  const requests: any = {
    ...
    animeRelations: backendRequest("animeRelations", { id }),
    animeRecommendations: backendRequest("animeRecommendations", { id }),
    animeCharacters: backendRequest("animeCharacters", { id }),
    ...
    animeSchedule: backendRequest("animeSchedule", { page }),
