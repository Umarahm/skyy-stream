...
const Watch = () => {
  ...
  const [source, setSource] = useState("RIVE");
      ...
      <div className={styles.watch}>
        ...
        <div className={styles.watchSelects}>
          {embedMode === true && (
            ...
            >
              <option value="RIVE">
                Aggregator : 0 (RiveStream - Default)
              </option>
        ...
        {source === "RIVE" && id !== "" && id !== null && embedMode === true ? (
          <iframe
            scrolling="no"
            src={
              type === "movie"
                ? `${STREAM_URL_RIVE}embed?type=movie&id=${id}`
                : `${STREAM_URL_RIVE}embed?type=tv&id=${id}&season=${season}&episode=${episode}`
            }
